...
def on_message(client, userdata, message):
    ...
    #Publicación de las medidas
    clientp=mqtt.Client('python_publish')
    clientp.connect(broker_address, broker_port, 60)
    clientp.publish('C02', separado[0])
